    ...
    <section className="py-24 lg:py-32 relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8 w-full">
        ...
        <div className="text-center">
          ...
          {/* Subheadline */}
          <p className="text-xl lg:text-2xl text-blue-200/80 mb-12 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="backdrop-blur-xl bg-blue-200/5 border border-blue-200/10 rounded-2xl p-8 hover:bg-blue-200/10 transition-all duration-500">
              <div className="text-4xl font-bold mb-2 text-blue-50">50+</div>
              <div className="text-blue-200/80">Brands Sculpted</div>
            </div>
            <div className="backdrop-blur-xl bg-blue-200/5 border border-blue-200/10 rounded-2xl p-8 hover:bg-blue-200/10 transition-all duration-500">
              <div className="text-4xl font-bold mb-2 text-blue-50">$200M+</div>
              <div className="text-blue-200/80">Raised by Partners</div>
            </div>
            <div className="backdrop-blur-xl bg-blue-200/5 border border-blue-200/10 rounded-2xl p-8 hover:bg-blue-200/10 transition-all duration-500">
              <div className="text-4xl font-bold mb-2 text-blue-50">95%</div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button className="px-8 py-4 bg-transparent border border-blue-200/30 rounded-full font-semibold text-lg text-blue-100 hover:bg-blue-200/10 transition-all duration-300">
              Schedule a Call
            </button>
            <button className="px-8 py-4 bg-transparent border border-blue-200/30 rounded-full font-semibold text-lg text-blue-100 hover:bg-blue-200/10 transition-all duration-300">
              Download Our Deck
          ...
          {/* Fine Print */}
          <p className="text-sm text-blue-300/70 mt-12 max-w-2xl mx-auto">
