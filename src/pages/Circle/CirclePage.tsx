          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div
              ...
              style={{
                ...
                background:
                  "radial-gradient(circle, rgba(200,185,170,0.35) 0%, rgba(160,145,185,0.6) 18%, rgba(120,105,175,0.8) 35%, rgba(140,125,185,0.55) 50%, rgba(170,160,205,0.3) 65%, rgba(200,195,225,0.12) 80%, transparent 100%)",
                filter: "blur(40px)",
              }}
            />
          </div>
